...
import { Coffee, Sparkles, CheckCircle2, Calendar, ArrowRight, Lock } from "lucide-react";
import {
...
export default function MugPrintingServicePage() {
  ...
  if (toggles.enableMugService === false) {
    return (
      <main className="min-h-screen bg-[#011F15] text-white selection:bg-[#D4AF37] selection:text-[#011F15]">
        ...
        <div className="pt-44 pb-28 px-4 text-center max-w-md mx-auto space-y-4">
          ...
          <h2 className="font-serif text-2xl font-bold text-white">Live Mug Printing Offline</h2>
