...
const services: ServiceItem[] = [
  {
    ...
    description:
      "Professional studio cameras paired with sub-10 second thermal print technology. Customized event overlays, instant digital QR sharing, and studio lighting.",
    badge: "Most Popular",
    ...
    <section id="services" className="py-24 bg-transparent relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-left max-w-3xl mb-12">
          ...
          <p className="font-sans text-emerald-100/80 text-base sm:text-lg font-light leading-relaxed">
              ...
              >
                <div>
                  ...
                  <div className="relative h-48 w-full overflow-hidden bg-black/40">
                    ...
                    {/* Badge */}
                    <div className="absolute top-3 right-3 px-3 py-1 rounded-full bg-black/50 border border-gold-500/40 text-gold-400 text-[11px] font-bold tracking-widest uppercase font-cinzel backdrop-blur-md">
                      {service.badge}
                    </div>
                  ...
                  <div className="p-6 pt-8 space-y-4">
                    <div className="inline-flex items-center space-x-1.5 text-xs text-gold-300 font-bold font-cinzel">
                      <Clock className="w-3.5 h-3.5 text-gold-500" />
                      <span>{service.speed}</span>
                    </div>

                    <h3 className="font-playfair text-xl sm:text-2xl font-bold text-white group-hover:text-gold-300 transition-colors">
                      {service.title}
                    </h3>

                    <p className="font-cormorant text-emerald-100/90 text-sm sm:text-base font-light leading-relaxed">
                      {service.description}
                    </p>
                ...
                <div className="p-6 pt-0 mt-4">
                  <a
                    href="#booking-engine"
                    className="w-full py-2.5 rounded-lg bg-black/40 border border-gold-500/30 text-gold-300 hover:bg-gold-500 hover:text-emerald-950 font-semibold text-xs transition-all duration-200 flex items-center justify-center space-x-1 backdrop-blur-sm"
                  >
